    ...
    ui(new Ui::LocationDialog)
{
    ...
    //------------------
//    this->loadgif = new QMovie("/home/saucy/work/pc-manager/src/image/loading.gif");
//    ui->loadingDiv->setPixmap(QPixmap("/home/saucy/work/pc-manager/src/image/div.png"));
...
QStringList LocationDialog::list_city_names(QString inputText) {
    QFile locationFile("/usr/lib/python2.7/dist-packages/pc-manager-daemon/src/weather/location.txt");
