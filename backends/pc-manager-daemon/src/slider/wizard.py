...
#
# Author:     Kobe Lee <xiangli@cdos.com>
# Maintainer: Ubuntu cdos
#
...
class Wizard(gtk.Window):
    def __init__(self):
        ...
        wizard_dir = "/usr/share/pc-manager/qml/img/zh_CN/wizard"
        wizard_root_dir = "/usr/share/pc-manager/qml/img/icons"
    ...
    def destroy_wizard(self, widget):
        print 'Pc-Manager slide show is over!'
        #widget.destory()
