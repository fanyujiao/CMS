...
INTERFACE = 'com.cdos.pc'
UKPATH = '/'
SHOWED = False

#def pc_error_dialog(title, message):
...
def show_message(*args):
    ...
    message = ('Pc Manager systemdaemon didn\'t start correctly.\n'
                'If you want to help developers debugging, try to run "<b>sudo /usr/lib/python2.7/dist-packages/pc-manager-daemon/src/pcsystem-daemon</b>" in a terminal.')
    #pc_error_dialog(title, message)
...
class AccessDeniedException(dbus.DBusException):
    ...
    _dbus_error_name = 'com.cdos.pc.AccessDeniedException'
