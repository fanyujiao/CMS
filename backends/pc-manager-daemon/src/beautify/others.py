...
class Others:
    ...
    def custom_plymouth_bg(self, plymouthName):
        ...
        existingDir = '/var/lib/pc-manager-daemon/plymouth/existing/'
    ...
    def add_new_plymouth(self, customBG, plymouthName):
        ...
        if(plymouthName in existingPlymouth):
            ...
            existingDir = '/var/lib/pc-manager-daemon/plymouth/existing/'
            customScript = '/var/lib/pc-manager-daemon/plymouth/defaults/only_background.script'
            defaultplymouthfile = '/var/lib/pc-manager-daemon/plymouth/defaults/default.plymouth'
            ...
            fileHandle.write('ScriptFile=/lib/plymouth/themes/' + plymouthName + '/pc.script')
            fileHandle.close()

            # add new system plymouth dir
            os.mkdir('/lib/plymouth/themes/' + plymouthName)
            shutil.copy(customScript, '/lib/plymouth/themes/' + plymouthName + '/pc.script')
    ...
    def get_existing_plymouth_list(self):
        result = []
        edir = ('/var/lib/pc-manager-daemon/plymouth/existing')
    ...
    def delete_plymouth(self,plymouthName):
        ...
        if used == plymouthName :
            ...
            shutil.rmtree('/var/lib/pc-manager-daemon/plymouth/existing/' + plymouthName)
