...
class Sound:
    ...
    def set_login_music_enable(self, flag):
        ...
        desktopfile = '/usr/share/pc-manager-daemon/autostart/libcanberra-login-sound.desktop'
    ...
    def get_sound_themes(self):
        bakDir = '/var/lib/pc-manager-daemon/sound-theme/'
    ...
    def restore_all_sound_file(self, soundTheme):
        bakSoundThemeDir = '/var/lib/pc-manager-daemon/sound-theme/' + soundTheme
